  ...
  export const trending = [
    {
      ...
      rating: 4.7,
      time: "2hr : 22mins",
      desc: "A young dinosaur embarks on an epic adventure to find his family after being separated from them, overcoming obstacles and learning about courage and resilience along the way.",
    ...
    },
    {
      ...
      rating: 4.6,
      time: "2hr : 22mins",
      desc: "A gripping tale of power and ambition, 'The Great Emperor' follows the rise and fall of a young ruler as he navigates the treacherous waters of politics, loyalty, and betrayal. ",
      starring: "Brenda Chapman, Jeff Nathanson",
      genres: "Adventures",
      tags: "Adventures,Action",
    ...
    },
    {
      ...
      rating: 4.8,
      time: "2hr : 22mins",
      desc: "the thrilling adventures of a colossal elephant who embarks on a quest to protect her herd from a dangerous poacher, showcasing themes of courage and survival. ",
      starring: "James Chinlund, Brenda Chapman",
      genres: "Adventures",
      tags: "Adventures,Animation,Family ",
